...
void TFT_eFEX::drawBmp(fs::F_Fat &fs,String filename, int16_t x, int16_t y, TFT_eSprite *_spr) {
...
void TFT_eFEX::drawJpeg(String filename, int16_t xpos, int16_t ypos, TFT_eSprite *_spr) {
  ...
  fs::File jpegFile = FFat.open( filename, "r");    // File handle reference for SPIFFS
